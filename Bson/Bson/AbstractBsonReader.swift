...
extension Context {
    func asReaderContext() -> BsonDocumentReader.ReaderContext {
        return self as! BsonDocumentReader.ReaderContext
    }

    func asBinaryContext() -> BsonBinaryReader.BinaryContext {
        return self as! BsonBinaryReader.BinaryContext
    }
}
...
class Mark: BsonReaderMark {
    ...
    internal let currentBsonType: BsonType
    internal let currentName: String

    internal var abstractBsonReader: AbstractBsonReader
...
public protocol AbstractBsonReader: class, BsonReader {
     ...
     */
    func doReadBinaryData() throws -> BsonBinary
     ...
     */
    func doPeekBinarySubType() throws -> Byte
     ...
     * @since 3.4
     */
    func doPeekBinarySize() throws -> Int
     ...
     */
    func doReadBoolean() throws -> Bool
     ...
     */
    func doReadDateTime() throws -> Int64
     ...
     */
    func doReadDouble() throws -> Double
     ...
     * @since 3.4
     */
    func doReadDecimal() throws -> Decimal
     ...
     */
    func doReadJavaScript() throws -> String
     ...
     * @return the String value
     */
    func doReadJavaScriptWithScope() throws -> String

    /**
     * Handles the logic to read a Max key
     */
    func doReadMaxKey() throws

    /**
     * Handles the logic to read a Min key
     */
    func doReadMinKey() throws

    /**
     * Handles the logic to read a null value
     */
    func doReadNull() throws
     ...
     */
    func doReadObjectId() throws -> ObjectId
     ...
     */
    func doReadRegularExpression() throws -> BsonRegularExpression
     ...
     */
    func doReadDBPointer() throws -> BsonDbPointer

    /**
     * Handles the logic to read the start of an array
     */
    func doReadStartArray() throws

    /**
     * Handles the logic to read the start of a document
     */
    func doReadStartDocument() throws
     ...
     * @return the String value
     */
    func doReadString() throws -> String
     ...
     * @return the String value
     */
    func doReadSymbol() throws -> String
     ...
     */
    func doReadTimestamp() throws -> BsonTimestamp

    /**
     * Handles the logic to read an Undefined value
     */
    func doReadUndefined() throws
...
extension AbstractBsonReader {
    ...
    public func readBinaryData() throws -> BsonBinary {
        ...
        state = try nextState()
        return try doReadBinaryData()
    }

    public func peekBinarySubType() throws -> Byte {
        try checkPreconditions(.binary)
        return try doPeekBinarySubType()
    }

    public func peekBinarySize() throws -> Int {
        try checkPreconditions(.binary)
        return try doPeekBinarySize()
    }
    ...
    public func readJavaScriptWithScope() throws -> String {
        ...
        state = .scopeDocument
        return try doReadJavaScriptWithScope()
    }
    ...
    public func readRegularExpression() throws -> BsonRegularExpression {
        ...
        state = try nextState()
        return try doReadRegularExpression()
    }
