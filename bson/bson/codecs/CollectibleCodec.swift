...
private protocol _CollectibleCodec: Codec {
    /**
     ...
     */
    func generateIdIfAbsentFromDocument(document: Decodee) -> Decodee
     ...
     */
    func documentHasId(document: Decodee) -> Bool
     ...
     */
    func getDocumentId(document: Decodee) -> BsonValue
}
