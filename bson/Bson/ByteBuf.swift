...
//
///**
// * <p>An interface wrapper around a {@code [Byte]} which additionally is {@code Closeable}, so that pooled byte buffers know
// * how.</p>
// *
...
//     */
//    func put(index: Int, b: Byte) -> ByteBuf
//
//    /**
...
//     * @throws java.nio.ReadOnlyBufferException If this buffer is read-only
//     */
//    func put(src: [Byte], offset: Int, length: Int) -> ByteBuf
//
//    /**
...
//     * @throws java.nio.ReadOnlyBufferException If this buffer is read-only
//     */
//    func put(b: Byte) throws -> ByteBuf
//
//    /**
...
//     */
//    func position(newPosition: Int) -> ByteBuf
//
//    /**
...
//     * @return This buffer
//     */
//    func order(byteOrder: CFByteOrder) -> ByteBuf
//
//    /**
...
//     * @throws java.nio.BufferUnderflowException If there are fewer than {@code length} bytes remaining in this buffer
//     */
//    func get(index: Int, bytes: [Byte]) -> ByteBuf
//
//    /**
...
//     */
//    func get(bytes: [Byte], offset: Int, length: Int) -> ByteBuf
//
//    /**
...
//     * @throws IndexOutOfBoundsException         If the preconditions on the {@code offset} and {@code length} parameters do not hold
//     */
//    func get(index: Int, bytes: [Byte], offset: Int, length: Int) throws -> ByteBuf
//
//    /**
...
//     */
//    func limit(newLimit: Int) -> ByteBuf
//
//
//    /**
